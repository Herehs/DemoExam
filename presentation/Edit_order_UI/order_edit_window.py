...
"}")
        ...
        self.gridLayout.addWidget(self.date_order, 13, 0, 1, 1)
...
"}")
        ...
        self.gridLayout.addWidget(self.product_name, 8, 0, 1, 1)
...
"}")
        ...
        self.gridLayout.addWidget(self.product_input, 9, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.count_order, 10, 0, 1, 1)
...
"}")
        ...
        self.gridLayout.addWidget(self.delivery_date, 15, 0, 1, 1)
...
"}")
        ...
        self.adres_input.addItem("")
        self.gridLayout.addWidget(self.adres_input, 5, 0, 1, 1)
        self.client_name_input = QtWidgets.QComboBox(parent=order_edit)
        self.client_name_input.setMouseTracking(True)
        self.client_name_input.setStyleSheet("#client_name_input {\n"
"    border: 1px solid black;\n"
"}\n"
"\n"
"#client_name_input:hover {\n"
"    border-color: #00FA9A;\n"
"}")
        self.client_name_input.setObjectName("client_name_input")
        self.client_name_input.addItem("")
        self.gridLayout.addWidget(self.client_name_input, 7, 0, 1, 1)
...
"}")
        ...
        self.gridLayout.addWidget(self.count_input, 11, 0, 1, 1)
...
"}")
        ...
        self.Client_name = QtWidgets.QLabel(parent=order_edit)
        font = QtGui.QFont()
        font.setFamily("Times New Roman")
        font.setPointSize(11)
        self.Client_name.setFont(font)
        self.Client_name.setObjectName("Client_name")
        self.gridLayout.addWidget(self.Client_name, 6, 0, 1, 1)
...
"}")
    ...
    def retranslateUi(self, order_edit):
        ...
        self.adres_input.setItemText(0, _translate("order_edit", "Не выбран"))
        self.client_name_input.setItemText(0, _translate("order_edit", "Не выбрано"))
        ...
        self.Client_name.setText(_translate("order_edit", "Имя пользователя:"))
