...
class Ui_List_of_products(object):
    def setupUi(self, List_of_products, db):
        ...
        self.sort_input.addItem("")
        self.sort_input.addItem("")
        self.sort_input.setMinimumWidth(180)
    ...
    def retranslateUi(self, List_of_products):
        ...
        self.sort_input.setItemText(1, _translate("List_of_products", "Количество по возрастанию"))
        self.sort_input.setItemText(2, _translate("List_of_products", "Количество по убыванию"))
