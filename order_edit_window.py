...
class Ui_order_edit(object):
    def setupUi(self, order_edit):
        ...
        self.articul_input = QtWidgets.QLineEdit(order_edit)
        font = QtGui.QFont()
...
"}")
        ...
        self.delivery_date = QtWidgets.QDateEdit(order_edit)
        font = QtGui.QFont()
        font.setFamily("Times New Roman")
        font.setPointSize(10)
...
"}")
        ...
        self.date_order = QtWidgets.QDateEdit(order_edit)
        font = QtGui.QFont()
        font.setFamily("Times New Roman")
        font.setPointSize(10)
...
"}")
        ...
        self.label_3 = QtWidgets.QLabel(order_edit)
        font = QtGui.QFont()
        font.setFamily("Times New Roman")
        ...
        self.label_2 = QtWidgets.QLabel(order_edit)
        font = QtGui.QFont()
        font.setFamily("Times New Roman")
        font.setPointSize(11)
        ...
        self.label = QtWidgets.QLabel(order_edit)
        font = QtGui.QFont()
        font.setFamily("Times New Roman")
        font.setPointSize(11)
        font.setBold(False)
        ...
        self.status_input = QtWidgets.QComboBox(order_edit)
        font = QtGui.QFont()
        font.setFamily("Times New Roman")
        font.setPointSize(10)
...
"}")
        ...
        self.adres_pvz_input = QtWidgets.QTextEdit(order_edit)
        font = QtGui.QFont()
        font.setFamily("Times New Roman")
        font.setPointSize(10)
...
"}")
        ...
        self.label_5 = QtWidgets.QLabel(order_edit)
        font = QtGui.QFont()
        font.setFamily("Times New Roman")
        font.setPointSize(11)
        ...
        self.label_4 = QtWidgets.QLabel(order_edit)
        font = QtGui.QFont()
        font.setFamily("Times New Roman")
        font.setPointSize(11)
        ...
        self.save_button = QtWidgets.QPushButton(order_edit)
...
"}")
        ...
        self.cancel_button = QtWidgets.QPushButton(order_edit)
